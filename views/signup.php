  ...
  <div class="d-flex justify-content-center align-items-center">
    <div class="px-5">
      <div class="mb-5">
        ...
        <div class="d-flex justify-content-center ">
          <h5 class="txt-red">Voltar para a <a href="/lar_tcc/" class="text-decoration-none txt-brown fw-bold"> Página inicial</a></h5>
        </div>
      </div>
      ...
      <div class="">
        ...
        <div class="d-flex justify-content-center mt-2">
          <a href="/lar_tcc/views/login.php" class="text-decoration-none txt-brown fw-bold fs-5"> Já tenho uma conta </a>
        </div>
      </div>
    </div>
  </div>
