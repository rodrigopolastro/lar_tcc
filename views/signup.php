      ...
      <div class="px-5">
        ...
        <!-- <div > -->
          ...
          <input type="hidden" name="operation" value="signup">
            <input type="text" id="userFirstNameInput" name="first_name" placeholder="Digite seu nome!" class="rounded-4 bg-red border-red txt-brown fw-bold mb-3">
            <input type="text" id="userLastNameInput" name="last_name" placeholder="Sobrenome" class="rounded-4 bg-red border-red txt-brown fw-bold mb-3">
        ...
        <div class="d-flex justify-content-center mt-2">
          <a href="/htdocsDirectories/lar_tcc/views/login.php" class="text-decoration-none txt-brown fw-bold fs-5"> Já tenho uma conta </a>
        </div>
      </div>
    </div>
  </div>
