  ...
  <div>
    <div class="d-flex justify-content-between">
      ...
      <div class="d-flex justify-content-end">
        <a href="/lar_tcc/views/construction/" class="d-flex align-items-center bg-green border-green rounded-3 h5 px-4 me-3 opacity-25">
          <img src="../../assets/images/icons/hammer.png" alt="">
        </a>
        <a href="/lar_tcc/views/tasks/" class="d-flex align-items-center bg-red border-red rounded-3 h5 px-4">
